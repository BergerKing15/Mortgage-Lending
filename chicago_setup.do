...
insheet using "K:\UROP\Data\chicago2019.csv" , comma case names
...
save "K:\UROP\Analysis\chicago2019.dta", replace
...
insheet using "K:\UROP\Data\chicago2020.csv" , comma case names
...
save "K:\UROP\Analysis\chicago2020.dta", replace
...
insheet using "K:\UROP\Data\chicago2021.csv" , comma case names
...
save "K:\UROP\Analysis\chicago2021.dta", replace
...
insheet using "K:\UROP\Data\chicago2022.csv" , comma case names
...
save "K:\UROP\Analysis\chicago2022.dta", replace
...
insheet using "K:\UROP\Data\chicago2023.csv" , comma case names
...
save "K:\UROP\Analysis\chicago2023.dta", replace

**************************************************************************************
use chicago2019.dta, clear
append using chicago2020.dta
append using chicago2021.dta
append using chicago2022.dta
append using chicago2023.dta

save chicago_hmda.dta, replace