...
insheet using "K:\UROP\Data\minneapolis2019.csv" , comma case names
...
save "K:\UROP\Analysis\minneapolis2019.dta", replace
...
insheet using "K:\UROP\Data\minneapolis2020.csv" , comma case names
...
save "K:\UROP\Analysis\minneapolis2020.dta", replace
...
insheet using "K:\UROP\Data\minneapolis2021.csv" , comma case names
...
save "K:\UROP\Analysis\minneapolis2021.dta", replace
...
insheet using "K:\UROP\Data\minneapolis2022.csv" , comma case names
...
save "K:\UROP\Analysis\minneapolis2022.dta", replace
...
insheet using "K:\UROP\Data\minneapolis2023.csv" , comma case names
...
save "K:\UROP\Analysis\minneapolis2023.dta", replace

**************************************************************************************
use minneapolis2019.dta, clear
append using minneapolis2020.dta, force
append using minneapolis2021.dta, force
append using minneapolis2022.dta, force
append using minneapolis2023.dta, force

save minneapolis_hmda.dta, replace