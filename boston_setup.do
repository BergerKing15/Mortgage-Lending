...
insheet using "K:\UROP\Data\boston2019.csv" , comma case names
...
save "K:\UROP\Analysis\boston2019.dta", replace
...
insheet using "K:\UROP\Data\boston2020.csv" , comma case names
...
save "K:\UROP\Analysis\boston2020.dta", replace
...
insheet using "K:\UROP\Data\boston2021.csv" , comma case names
...
save "K:\UROP\Analysis\boston2021.dta", replace
...
insheet using "K:\UROP\Data\boston2022.csv" , comma case names
...
save "K:\UROP\Analysis\boston2022.dta", replace
...
insheet using "K:\UROP\Data\boston2023.csv" , comma case names
...
save "K:\UROP\Analysis\boston2023.dta", replace

**************************************************************************************
use boston2019.dta, clear
append using boston2020.dta, force
append using boston2021.dta, force
append using boston2022.dta, force
append using boston2023.dta, force

save boston_hmda.dta, replace