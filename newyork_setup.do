...
insheet using "K:\UROP\Data\newyork2019.csv" , comma case names
...
save "K:\UROP\Analysis\newyork2019.dta", replace
...
insheet using "K:\UROP\Data\newyork2020.csv" , comma case names
...
insheet using "K:\UROP\Data\newyork2021.csv" , comma case names
...
insheet using "K:\UROP\Data\newyork2022.csv" , comma case names
...
insheet using "K:\UROP\Data\newyork2023.csv" , comma case names
...
save "K:\UROP\Analysis\newyork2023.dta", replace

**************************************************************************************
use newyork2019.dta, clear
append using newyork2020.dta, force
append using newyork2021.dta, force
append using newyork2022.dta, force
append using newyork2023.dta, force

save newyork_hmda.dta, replace